...
class Report(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['cb_uuid', 'year_evaluated'],
                name='%(app_label)s_%(class)s_cb_uuid_year_evaluated_key'
            ),
            models.UniqueConstraint(
                fields=['cb_url', 'year_evaluated'],
                name='%(app_label)s_%(class)s_cb_url_year_evaluated_key'
            ),
        ]
    ...
    def get_absolute_url(self):
        return reverse('dual-use:report-detail', kwargs={'uuid': self.uuid})
