...
urlpatterns = [
    ...
    path("api/docs/", SpectacularRedocView.as_view(url_name="openapi-schema"), name="api-docs"),
    path("api/swagger-ui/", SpectacularSwaggerView.as_view(url_name="openapi-schema"), name="api-swagger-ui"),
]
