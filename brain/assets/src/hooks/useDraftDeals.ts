...
export const useDraftDeals = () => {
    ...
    const createDraftDeal = async (data: CreateDraftDealRequest): Promise<DraftDeal> => {
        setIsLoading(true);
        setError(null);
    ...
    const updateDraftDeal = async (
        uuid: string,
        data: Partial<CreateDraftDealRequest>,
    ): Promise<DraftDeal> => {
        setIsLoading(true);
        setError(null);
    ...
    const finalizeDraftDeal = async (uuid: string): Promise<DraftDeal> => {
        setIsLoading(true);
        setError(null);
    ...
    const getDraftDeal = async (uuid: string): Promise<DraftDeal> => {
        setIsLoading(true);
        setError(null);
    ...
    const getDraftDeals = async (): Promise<DraftDeal[]> => {
        setIsLoading(true);
        setError(null);
    ...
    const deleteDraftDeal = async (uuid: string): Promise<void> => {
        setIsLoading(true);
        setError(null);
