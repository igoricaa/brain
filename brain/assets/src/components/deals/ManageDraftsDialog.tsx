...
export default function ManageDraftsDialog({
    ...
    }, [isOpen, getDraftDeals]);

    useEffect(() => {
        loadDrafts();
    }, [loadDrafts]);

    const handleDeleteDraft = useCallback(async (draftUuid: string) => {
        try {
                ...
                <DialogContent className="max-w-3xl max-h-[90vh]">
                        ...
                        <div className="space-y-4">
                            {loading ? (
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-500 mb-4">Create your first draft deal to get started.</p>
                                ...
                                drafts.map((draft) => (
                                    <Card
                                        key={draft.uuid}
                                        className="shadow-sm cursor-pointer hover:shadow-md transition-all duration-200 border hover:border-blue-200"
                                                    ...
                                                    <div className="flex items-center gap-6 text-sm">
                                                        ...
                                                        {draft.website && (
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                >
                                                                    {new URL(draft.website).hostname}
                                                                </a>
                                                            </div>
                                                        )}
                    ...
                    <DialogFooter className="border-t pt-6">
                        <div className="flex flex-col sm:flex-row justify-between items-center w-full gap-4">
                            ...
                            <Button onClick={handleCreateNew} className="h-11 px-8">
                                <Plus className="h-4 w-4 mr-2" />
                                Create New Deal
                            </Button>
                        </div>
            ...
            <AlertDialog open={!!deleteConfirm} onOpenChange={() => setDeleteConfirm(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Are you sure you want to delete this draft? This action cannot be undone and all uploaded files will be removed.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
