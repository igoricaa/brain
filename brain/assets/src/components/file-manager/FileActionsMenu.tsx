            ...
            <DropdownMenuSubContent className="w-64">
              ...
              <div className="px-2 py-1.5 space-y-2 text-xs">
                <div>
                  ...
                  <div className="text-muted-foreground break-all">{file.name}</div>
                </div>
                ...
                {file.document_type && (
                  <div>
                    ...
                    <div className="text-muted-foreground">{file.document_type}</div>
                  </div>
                )}
                ...
                {file.proprietary && (
                  <div>
                    <Badge variant="outline" className="text-xs text-orange-600 shadow-sm">
                      Proprietary
                    </Badge>
                  </div>
                )}
                  ...
                  <div className="mt-1">
                    <Badge 
                      variant={
                        ...
                        file.processing_status === 'processing' ? 'default' :
                        file.processing_status === 'failed' ? 'destructive' : 
                        'secondary'
                      }
                      className={
                        file.processing_status === 'completed' ? 'bg-green-100 text-green-800' : undefined
                      }
                    >
                ...
                {file.processing_status === 'completed' && (
                  <div className="bg-red-50 shadow-sm rounded-lg p-3">
                    ...
                    <p className="text-sm text-red-700 mt-1">
                      This file has been processed. All extracted data and analysis will be permanently lost.
                    </p>
                  </div>
                )}
                ...
                {file.processing_status === 'processing' && (
                  <div className="bg-yellow-50 shadow-sm rounded-lg p-3">
                    ...
                    <p className="text-sm text-yellow-700 mt-1">
                      This file is currently being processed. Deleting it will stop the processing.
                    </p>
                  </div>
                )}
              </div>
