...
export default function BulkMetadataDialog({
  ...
  const handleSubmit = useCallback(async (data: BulkMetadataFormData) => {
    ...
    if (mode === 'library') {
      ...
      if (data.source !== undefined && data.source.trim()) (updateData as any).source = data.source.trim();
    }
  ...
  const clearField = useCallback((fieldName: keyof BulkMetadataFormData) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Update metadata for selected files. Only the fields you modify will be changed.
          </DialogDescription>
        </DialogHeader>
        ...
        <ScrollArea className="flex-1 -mx-6 px-6">
          <div className="space-y-6">
              ...
              <div className="bg-muted rounded-lg p-3 max-h-32 overflow-y-auto">
                <div className="space-y-1">
                  {selectedFiles.slice(0, 5).map((file) => (
                    <div key={file.uuid} className="text-xs text-muted-foreground flex items-center gap-2">
            ...
            {(uniqueCategories.length > 0 || uniqueDocTypes.length > 0 || uniqueTags.length > 0) && (
              <div className="space-y-2">
                <h4 className="text-sm font-medium">Current Values in Selected Files</h4>
                <div className="bg-blue-50 rounded-lg p-3 space-y-2">
                  {uniqueCategories.length > 0 && (
                    <div>
                      <span className="text-xs font-medium text-blue-800">Categories: </span>
                  ...
                  {uniqueDocTypes.length > 0 && (
                    <div>
                      <span className="text-xs font-medium text-blue-800">Document Types: </span>
                      <div className="flex flex-wrap gap-1 mt-1">
                  ...
                  {uniqueTags.length > 0 && (
                    <div>
                      <span className="text-xs font-medium text-blue-800">Tags: </span>
                      <div className="flex flex-wrap gap-1 mt-1">
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>
                          Check to mark all selected files as containing proprietary information
                        </FormDescription>
                      </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Will replace the summary for all selected files (max 500 characters)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          ...
                          <div className="space-y-1 leading-none">
                            ...
                            <FormDescription>
                              Check to make all selected files publicly accessible
                            </FormDescription>
                          </div>
                          {field.value !== undefined && (
                            <Button
