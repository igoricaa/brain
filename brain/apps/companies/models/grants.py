...
class Grant(models.Model):
    ...
    potential_amount = models.DecimalField(
        _('potential amount (USD)'), max_digits=15, decimal_places=2, blank=True, null=True
    )
    obligated_amount = models.DecimalField(
        _('obligated amount (USD)'), max_digits=15, decimal_places=2, blank=True, null=True
    )
    ...
    award_month = models.PositiveIntegerField(
        _('award month'), blank=True, null=True, validators=[MinValueValidator(1), MaxValueValidator(12)]
    )
