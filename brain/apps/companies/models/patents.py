...
class PatentApplication(models.Model):
    ...
    confirmation_number = models.SmallIntegerField(_('application confirmation number'), blank=True, null=True)
    ...
    type_code = models.CharField(
        ...
        blank=True,
        help_text=_(
            'The specific value that indicates if the received patent application is considered a '
    ...
    publication_sequence_numbers = ArrayField(
        ...
        help_text=_(
            'Contains a number assigned to the publication of patent applications filed on or after '
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['number', 'company_id'], name='%(app_label)s_%(class)s_number_company_id'),
        ]
