...
class PatentApplicationUpdateView(LoginRequiredMixin, SuccessMessageMixin, UpdateView):
    ...
    def get_success_message(self, cleaned_data):
        return format_lazy('Patent Application {title} was successfully updated.', title=self.object.invention_title)
...
class PatentApplicationDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, format_lazy(f'Patent Application: {title} deleted.', title=title))
