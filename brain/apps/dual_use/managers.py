...
class ReportManager(models.Manager):
    ...
    def pull_crunchbase_data(self, batch_size=100, **kwargs):
        ...
        yield from self.bulk_create_or_update(companies, unique_fields=['cb_uuid'], batch_size=batch_size)
    ...
    def _pull_crunchbase_data(cls, api_key=None, limit=100, **kwargs):
        ...
        for item in data:
            ...
            company_data = {
                ...
                'extras': {
                    'crunchbase': {
                        k: v.isoformat() if isinstance(v, datetime.datetime) else v for k, v in item.items()
                    }
                },
